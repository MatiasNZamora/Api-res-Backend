      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            // hace la peticion o consulta y lo guarda en la constante.
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", res.status(400).json({
              message: 'Faltan datos #badRequest'
            }));
          case 4:
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            pool = _context6.sent;
            _context6.next = 9;
            return pool.request().input('name', _database.sql.VarChar, name).input('description', _database.sql.Text, description).input('quantity', _database.sql.Int, quantity).input('id', _database.sql.Int, id).query(_database.querys.updateProductById);
          case 9:
            res.json({
              name: name,
              description: description,
